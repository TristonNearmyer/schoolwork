...
function pageAnimation(){
	...
	let navigation = document.querySelector("nav");
		...
		let mainPos = 700;
		if (windowWidth < 500){mainPos = 900}
		let mainId = setInterval(mainAnimation, 1);
...
function displayChiliRecipe(){
	...
	document.querySelector(".image").innerHTML = "<img id='recipeImage' alt='chili'>";
	document.querySelector("#recipeImage").setAttribute("src", chiliRecipe.image);
...
function displayCornbreadRecipe(){
	...
	document.querySelector(".image").innerHTML = "<iframe width='100%' height='400px' src='https://www.youtube.com/embed/16YfyByvLZg?controls=1&cc_load_policy=1&autoplay=1&mute=1' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>";
...
function displayPecanPieRecipe(){
	...
	document.querySelector(".image").innerHTML = "<img id='recipeImage' alt='pecan pie'>";
	document.querySelector("#recipeImage").setAttribute("src", pecanPieRecipe.image);
...
//for displaying add recipe form

function displayAddUserRecipeForm(){
	
	document.querySelector("#chiliRecipe").style.display = "none";
	document.querySelector(".addRecipeForm").style.display = "flex";
	document.querySelector(".products").style.display = "none";
	
	setCookie("current recipe","recipeForm");
...
function displayStore(){
	...
	setCookie("current recipe","store");
}
...
function checkCookie(){
	...
	if (currentRecipe == "recipeForm"){

		displayAddUserRecipeForm();
...
function digitalPurchase(){
	document.querySelector("#digitalPurchase").style.display = "flex";
	document.querySelector("#physicalPurchase").style.display = "none";
	
	document.querySelector("#formatPrice").innerHTML = "Price: $19.99";
}

function physicalPurchase(){
	document.querySelector("#physicalPurchase").style.display = "flex";
	document.querySelector("#digitalPurchase").style.display = "none";
	
	document.querySelector("#formatPrice").innerHTML = "Price: $24.99";
}

function formatChange(){
	let format = document.querySelector("#formatSelect").value;
...
function monthSub(){
	document.querySelector("#monthSub").style.display = "flex";
	document.querySelector("#yearSub").style.display = "none";
	
	document.querySelector("#subPrice").innerHTML = "Price: $10.99";
}

function yearSub(){
	document.querySelector("#monthSub").style.display = "none";
	document.querySelector("#yearSub").style.display = "flex";
	
	document.querySelector("#subPrice").innerHTML = "Price: $90.99";
}

function subChange(){
	let sub = document.querySelector("#subSelect").value;
