...
studentArray.push(student1Info);
studentArray.push(student2Info);
studentArray.push(student3Info);

console.log(studentArray);

let studentInfoJSON = JSON.stringify(studentArray);
localStorage.setItem("Student Info", studentInfoJSON);
